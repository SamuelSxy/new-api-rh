...
const FEATURE_ITEMS: FeatureItem[] = [
  {
    type: 'simple',
    iconUrl: 'https://ai-gc.tos-cn-beijing.volces.com/asset/icon-3.svg',
    title: '湖南省级AIGC聚合平台',
    subtitle: '湖南人自己的AI主场',
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className='relative mx-auto max-w-[1320px]'>
        <div className='grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:items-stretch'>
          {/* Left: Feature items */}
          ...
          {/* Right: Swiper carousel — on lg, fills the left column's height (carousel + dots as a whole) */}
          <div className='relative flex flex-col lg:col-span-7'>
            <div className='flex w-full flex-col items-center gap-6 lg:absolute lg:inset-0 lg:gap-4'>
              <div className='hero-swiper h-[370px] w-full overflow-hidden rounded-3xl lg:h-auto lg:min-h-0 lg:flex-1'>
                <Swiper
