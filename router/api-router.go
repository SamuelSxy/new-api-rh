...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/runninghub/ai_app/run", middleware.RootAuth(), controller.RunningHubRunAIAppTask)
			channelRoute.POST("/runninghub/ai_app/demo", middleware.RootAuth(), controller.RunningHubGetAIAppCallDemo)
			channelRoute.POST("/runninghub/public_models", middleware.RootAuth(), controller.RunningHubGetPublicModelList)
			channelRoute.POST("/runninghub/account/info", middleware.RootAuth(), controller.RunningHubGetAccountInfo)
			channelRoute.POST("/runninghub/account/api_keys", middleware.RootAuth(), controller.RunningHubListAPIKeys)
			channelRoute.POST("/runninghub/account/queue_status", middleware.RootAuth(), controller.RunningHubGetAPIKeyQueueStatus)
